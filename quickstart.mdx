...
<img
  ...
  alt="Monophonic.io Login / Sign-Up Screen"
/>

To get your band's website launched, start by visiting https://manage.monophonic.site/signup and, well, sign up. No credit card needed, and you'll get a 14-day trial.
...
<Steps>
  ...
  <Step title="Artist Information">
    Next, you'll enter the name of your band or of yourself as an artist.
  </Step>
  <Step title="Subdomain">
    By default, you get a monophonic subdomain, e.g. "myband.monophonic.site", so enter your desired subdomain (you'll be able to connect a custom domain if you want later on)
  </Step>
</Steps>
...
<img
  ...
  alt="Monophonic.site dashboard with empty track content"
/>

Monophonic.io supports various kinds of content to display in your site, including Tracks, Shows, Photos, Videos, and others. Before you can show any of this conent in your site, you'll need to add it to the system.
...
<img
  ...
  alt="Choosing sections for your Monophonic.io site"
/>
