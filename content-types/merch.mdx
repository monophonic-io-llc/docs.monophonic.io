...
| :---------- | :----------- |
| `Product Name` | The name of the merch item. |
| `URL` | A link to where a visitor can actually purchase the item, e.g. a shopify link. |
| `Price` | The price of the item (in USD). |
| `Description` | A short description of the merch item. |
| `Image` | An image of the merch item. |
