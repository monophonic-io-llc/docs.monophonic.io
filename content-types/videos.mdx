---
title: 'Videos'
description: 'How to add and manage videos in MNPHNC'
icon: 'film'
---
...
<Warning>For now, we only support YouTube Urls, which automatically become embedded YouTube players in the website. But we're adding support for more options soon! Message us at support@mnphnc.com if there's a video you service you want us to support!</Warning>