...
description: 'The basic building block of a MNPHNC site'
icon: 'question'
---
...
<img
  ...
  alt="MNPHNC Site Sections"
/>

A "Section" is exactly what it sounds like, unsurprisingly... It's just a portion of the website you build with MNPHNC.
...
Every Section shares some common features, which are accessible in the upper right corners of each section when managing your site in the MNPHNC dashboard under the "Settings" button. They are:
