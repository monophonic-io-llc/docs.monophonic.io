...
You can apply a domain you own to your MNPHNC site. For example, if your band is called "Non-Union Background", your default MNPHNC url will be:

```
nonunionbackground.mnphnc.com
```

...but if you buy the domain "nonunionbackground.com" from a domain registrar like [Gandi.net](https://gandi.net), you can set that domain to point to your MNPHNC-powered site.
...
<Note>We're working on creating easier, more automated options for setting up your custom domain with MNPHNC so it's much easier, but in the mean time, if you'd like some help with this, message us at support@mnphnc.com</Note>

## Connecting your Domain to MNPHNC

Once you have a domain, you can set it up to point to your MNPHNC site. You have two options...
...
Log into your MNPHNC dashboard, and click "Domains" in the left-hand menu under "Configuration.
...
### Option 2: Use MNPHNC Nameservers

If you select this option, it means that you'll manage ALL of your DNS records inside MNPHNC. There's no significant advantage to this option over the first described above, so choose whichever you prefer.
...
Once completed, you'll be able to add DNS records as needed right within MNPHNC. So if you need to add MX records for email or other records, feel free.

However, the records needed to point your domain to your MNPHNC website will be set up automatically.

<Note>Again, this is technical stuff, so if you'd like some help, message us at support@mnphnc.com. We'll give you a hand.</Note>
